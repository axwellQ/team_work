...
6. **Создаём**  в корне `README.md` в которой должны попасть gitverse аккаунты всех участников действа, описание того как выполнялась работа (в каких моделях), добротное описание созданного кода и структуры репозитория вцелом 
